...
int CItemBase::IsID_Door(ITEMID_TYPE id)	// static
{
	...
	static const ITEMID_TYPE sm_Item_DoorBase[] =
	{
		...
		ITEMID_DOOR_CRYSTAL,
		ITEMID_DOOR_SHADOW,
		ITEMID_DOOR_GARGISH_TRADIT,
		ITEMID_DOOR_GARGISH,
		ITEMID_DOOR_GARGISH_CELEST,
		ITEMID_DOOR_GARGISH_PROG,
		ITEMID_DOOR_GARGISH_REN,
		ITEMID_DOOR_GARGISH_DRAX,
		ITEMID_DOOR_GARGISH_HOVEL,
		ITEMID_DOOR_GARGISH_QUEEN_H,
		ITEMID_DOOR_QUEEN,
		ITEMID_DOOR_GARGISH_QUEEN,
		ITEMID_DOOR_GARGISH_BENTAS,
		ITEMID_DOOR_GARGISH_FOLSOM,
		ITEMID_DOOR_JUNGLE,
