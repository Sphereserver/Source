...
*/
int FindTable(LPCTSTR pszFind, const LPCTSTR *ppszTable, size_t iCount, size_t iElemSize = sizeof(const BYTE *));
/**
...
* @return the index of string if success, -1 otherwise.
*/
int FindTableSorted(LPCTSTR pszFind, const LPCTSTR *ppszTable, size_t iCount, size_t iElemSize = sizeof(const BYTE *));
/**
...
* @return the index of string if success, -1 otherwise.
*/
int FindTableHead(LPCTSTR pszFind, const LPCTSTR *ppszTable, size_t iCount, size_t iElemSize = sizeof(const BYTE *));
/**
...
* @return the index of string if success, -1 otherwise.
*/
int FindTableHeadSorted(LPCTSTR pszFind, const LPCTSTR *ppszTable, size_t iCount, size_t iElemSize = sizeof(const BYTE *));
