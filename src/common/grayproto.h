...
extern size_t CvtSystemToNUNICODE(NCHAR *pOut, int iSizeOutChars, LPCTSTR pInp, int iSizeInBytes);
extern size_t CvtNUNICODEToSystem(TCHAR *pOut, int iSizeOutBytes, const NCHAR *pInp, int iSizeInChars);
...
enum PACKETEXT_TYPE		// extended packets used by PACKET_ExtendedData
{
	...
	PACKETEXT_SpecialMoveClear		= 0x21,	// client <-  server
...
enum PACKETENC_TYPE		// encoded packets used by PACKET_EncodedData
{
	...
	PACKETENC_SpecialMoveSelect		= 0x19,	// client  -> server
