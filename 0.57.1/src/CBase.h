...
enum IT_TYPE		// double click type action.
{
	...
	IT_UNUSED_25,			// 25 = <unused>
	IT_UNUSED_26,			// 26 = <unused>
	...
	IT_UNUSED_93,		// 93	= <unused>
	IT_EXPLOSION,			// 94 = async explosion.
	IT_UNUSED_95,		// 95	= <unused>
	...
	IT_EQ_STUCK,		// 120
	IT_UNUSED_121,		// 121 = <unused>
	IT_UNUSED_122,		// 122 = <unused>
...
public:
	...
	DWORD m_Anims;	// Bitmask of animations available for monsters.
