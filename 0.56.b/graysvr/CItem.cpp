...
bool CItem::r_WriteVal( LPCTSTR pszKey, CGString & sVal, CTextConsole * pSrc )
{
	...
	switch ( index )
	{
		...
		case IC_HITFIREBALL:
		case IC_HITHARM:
		case IC_HITLEECHLIFE:
		case IC_HITLEECHMANA:
		case IC_HITLEECHSTAM:
		...
		case IC_INCREASEGOLD:
		case IC_INCREASEHITCHANCE:
		case IC_INCREASEKARMALOSS:
		...
		case IC_RESENERGY:
		case IC_RESFIRE:
		case IC_RESONANCECOLD:
		case IC_RESONANCEENERGY:
		case IC_RESONANCEFIRE:
		case IC_RESONANCEKINETIC:
		...
		case IC_SLAYERSUPER:
		case IC_SOULCHARGE:
		case IC_SOULCHARGECOLD:
		case IC_SOULCHARGEENERGY:
		case IC_SOULCHARGEFIRE:
