...
do_default:
	...
	switch ( iKeyNum )
	{
		...
		case CHC_EATERCOLD:
		case CHC_EATERDAM:
		case CHC_EATERENERGY:
		case CHC_EATERFIRE:
		case CHC_EATERKINETIC:
		case CHC_EATERPOISON:
		...
		case CHC_HITAREAPHYSICAL:
		case CHC_HITAREAPOISON:
		case CHC_HITCURSE:
		case CHC_HITDISPEL:
		case CHC_HITFATIGUE:
		case CHC_HITFIREBALL:
		case CHC_HITHARM:
		case CHC_HITLEECHLIFE:
		case CHC_HITLEECHMANA:
		case CHC_HITLEECHSTAM:
		case CHC_HITLIGHTNING:
		case CHC_HITLOWERATK:
		case CHC_HITLOWERDEF:
		case CHC_HITMAGICARROW:
		case CHC_HITMANADRAIN:
		case CHC_INCREASEDAM:
		case CHC_INCREASEDEFCHANCE:
		case CHC_INCREASEGOLD:
		case CHC_INCREASEHITCHANCE:
		case CHC_INCREASEKARMALOSS:
		case CHC_INCREASESPELLDAM:
		case CHC_INCREASESWINGSPEED:
		case CHC_LOWERAMMOCOST:
		...
		case CHC_REGENMANA:
		case CHC_REGENSTAM:
		case CHC_RESONANCECOLD:
		case CHC_RESONANCEENERGY:
		case CHC_RESONANCEFIRE:
		case CHC_RESONANCEKINETIC:
		case CHC_RESONANCEPOISON:
		case CHC_RESPHYSICAL:
		case CHC_SLAYER:
		case CHC_SLAYERLESSER:
		case CHC_SLAYERMISC:
		case CHC_SLAYERSUPER:
		case CHC_SOULCHARGE:
		case CHC_SOULCHARGECOLD:
		case CHC_SOULCHARGEENERGY:
		case CHC_SOULCHARGEFIRE:
		case CHC_SOULCHARGEKINETIC:
		case CHC_SOULCHARGEPOISON:
		case CHC_SPELLCONSUMPTION:
		case CHC_SPELLFOCUSING:
