...
O_FLAGS		= $(CODE_GEN_FLAGS) $(GENERAL_FLAGS) $(LINKER_FLAGS) $(O_WARNING_FLAGS)
CO_FLAGS	= $(CODE_GEN_FLAGS) $(GENERAL_FLAGS) $(LINKER_FLAGS) $(CO_WARNING_FLAGS)
C_FLAGS		= $(ARCH_FLAGS) $(BUILD_DEFS) $(INCLUDE_DIRS) $(OPTIMIZATION_FLAGS)
CC_FLAGS	= $(ARCH_FLAGS) $(BUILD_DEFS) $(INCLUDE_DIRS) $(OPTIMIZATION_FLAGS)
